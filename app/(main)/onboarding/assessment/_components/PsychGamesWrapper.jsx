...
export default function PsychGamesWrapper({ history, onComplete }) {
    ...
    useEffect(() => {
        ...
        const buildSummary = () => {
            if (!history || history.length === 0) return "A student exploring career options in technology.";
            return history
                .filter(h => h.type !== "psych")
                .map(h => `[${h.layerId}] Q: ${h.question} A: ${h.answer}`)
                .slice(0, 20)
                .join("\n");
        };
        ...
        const fetchContent = async () => {
            try {
                ...
                const content = await generatePsychGameContent({ type: "STUDENT", summary });
        ...
        return (
            <div className="flex flex-col items-center justify-center py-16 space-y-5">
                ...
                <div className="text-center space-y-1.5">
                    ...
                    <p className="text-sm text-muted-foreground">Crafting scenarios based on your career answers</p>
                </div>
                <div className="w-48">
